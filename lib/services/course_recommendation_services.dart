...
class CourseRecommendationServices {
  ...
  String? token =
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdXRob3JpemVkIjp0cnVlLCJjcmVhdGVkX2F0IjoiMjAyMy0xMS0yNFQxNDozMzoxOS4wNDhaIiwiZW1haWwiOiJ0ZXN0c3R1ZGVudEBnbWFpbC5jb20iLCJleHAiOjE3MDIxMzg3NzcsImlkIjoyLCJyb2xlX25hbWUiOiJzdHVkZW50IiwidXNlcm5hbWUiOiJ0ZXN0c3R1ZGVudCJ9.-N9qMvMvxNaqRMHXhYuwnXabWpAxRXjcNCkA0mabIBU';
...
void main() async {
  print(await CourseRecommendationServices().getRecommendation(maxItem: 5));
}
